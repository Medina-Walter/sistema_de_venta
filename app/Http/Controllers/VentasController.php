...
class VentasController extends Controller
{
    ...
    public function agregar_carrito($id_producto){
        ...
        $items_carrito = Session::get('item_carrito', []);
    ...
    public function vender(){
        ...
        try {
            ...
            Session::forget('items_carrito');
            DB::commit();
            return to_route('ventas-nueva')->with('success', 'Venta Realizada con Excito!');
        } catch (Exception $e) {
            DB::rollBack();
            dd($e->getMessage());
            return to_route('ventas-nueva')->with('error', 'No se realizo la Venta!' . $e->getMessage());
        }
    }
}
